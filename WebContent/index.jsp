...
<head>
    ...
    <!-- Title Tag -->
    <title>Mariana Andrade & Pedro Castanha</title>
<!--
...
<div class="DesignHolder">
	...
	<div class="LayoutFrame">
        ...
        <header>
            <div class="Center">
                <div class="site-logo">
                	<h1><a href="#"><i>Mariana <span>&</span> Pedro</i></a></h1>
                </div>
               <div id="mobile_sec">
                ...
                <div class="menumobile">
                    ...
                    <nav class="Navigation">
                        <ul>
                            ...
                            <li>
                                <a href="#pricing">História</a>
                                <span class="menu-item-bg"></span>
                            </li>
                            <li>
                                <a href="#services">Companhias</a>
                                <span class="menu-item-bg"></span>
                            </li>
                            <li>
        ...
        <div class="Banner_sec" id="home">
            ...
            <div class="bannerside">
	            <div class="Center">
                    <!--  \\ Begin Left Side -->
                    <div class="leftside"> <!-- November is a professional website template that is responsive and mobile friendly for any device. This template is provided by templatemo.com -->
                        <h3># Mari &<br>Castanha<span> NUTS</span></h3>
                        <p>Poste suas fotos no Instagram com a HashTag acima e elas aparecerão no nosso site! Ajude-nos a construír um album especial!</p>
                    ...
                    <div class="rightside">
                    	<ul id="slider">
							<li>
                                <div class="Slider">
                                    <figure><img src="img/teste-bg.jpg" alt="image"></figure>
                                    <div class="text">
                                        <div class="Icon">
                                            <ul>
                                        ...
                                        <div class="Lorem">
                                            <p>Pedido de noivado <span>Pedro Castanha</span></p>
                                        </div>
                                    </div>
                                </div>
							</li>
        ...
        <div class="Pricing_sec About_sec" id="pricing">
            <div class="Center">
                <h2>Historia</h2>
				...
				<div class="Tabside">
                      <div class="clear"></div>
                        <div id="image_container">
                            <div class="TabImage" style="float: right;">
                                <div class="img2">
                                    <figure><img src="img/London.jpg" alt="image" style="border-radius: 100px 100px 20px 20px; transform: rotate(-90deg);"></figure>
                                </div>
                            </div>
        ...
        <div class="Services_sec About_sec" id="services">
			<div class="Center">            	
				<h2>Nossas Companhias</h2>            		
				  ...
				  <div class="clear"></div>
					<div class="tabcontent" id="cont-1-1">
						<div class="TabImage" style="width: 50%; left: 18%;">
							<div class="img1" style="left: 140px; opacity: 0.95;">
								<figure><img src="img/Img-mariana-sm.jpg" alt="image" style="border-radius: 50%;"></figure>	
							</div>
							<div class="img2" style="opacity: 0.80">
								<figure><img src="img/Img-pedro-sm.jpg" alt="image" style="border-radius: 50%;"></figure>
							</div>
						</div>
						<div class="Description" style="width: 50%;">
							<h3 style="color: white;">Sed ac urna sit amet lorem<span>taciti sociosqu ad litora torquent per conubia</span></h3>
							<!--p>November is free HTML CSS website template from <span class="cyan">templatemo</span> and you can download and use it for any purpose. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam elit nunc, porta commodo euismod eu, fermentum a neque. Fusce scelerisque tincidunt auctor. Integer varius ullamcorper interdum.</p>
							<p>Phasellus pretium elementum rhoncus. Aenean sit amet odio eu ante volutpat rutrum. Vestibulum ullamcorper faucibus orci, in blandit massa fringilla at. Nulla in fermentum eros. Suspendisse vitae aliquam metus.</p-->
						</div>
					</div>
        ...
        <!-- \\ Begin About Section \\ -->
		<div class="About_sec Services_sec" id="about" style="background: white;">
			<div class="Center">
                <h2 style="color: black;">Listas de Casamento</h2>
                <p style="color: #8f8f8f;"> Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non  mauris vitae erat consequat auctor eu in elit. Class aptent<br> taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.</p>		
                <div class="Line"></div>
                <!-- \\ Begin Services Side  \\ -->
                <div class="Serviceside">
                    <ul>
	                    <li class="Development"><a href="#services"><h4>TECNOLOGIA</h4></a></li>
    	                <li class="Desdin"><a href="#services"><h4>DECORAÇÃO</h4></a></li>
	                    <li class="Concept"><a href="#services"><h4>UTENSÍLIOS</h4></a></li>
	                    <li class="System"><a href="#services"><h4>DIVERSOS</h4></a></li>
                    </ul>
                </div>
                <!-- // End Services Side // -->
            </div>
        ...
        <div class="Contact_sec" id="contact">
            <div class="Contactside">
                ...
                <div class="Get_sec">
                    ...
                    <footer>
                        <div class="Cntr">                
                            <p>COPYRIGHT © 2016 PEDRO MATOS CASTANHA. DESIGN: <a rel="nofollow" href="http://www.templatemo.com" target="_parent">TEMPLATEMO</a></p>
                        </div>
                    </footer>
                    <!-- // End Footer // -->
                </div>
